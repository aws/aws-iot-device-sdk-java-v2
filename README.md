...
#     (Use the latest version of the CRT here instead of "v0.23.0")
git clone --branch v0.23.0 --recurse-submodules https://github.com/awslabs/aws-crt-java.git
cd aws-crt-java
...
dependencies {
    implementation 'software.amazon.awssdk.crt:android:0.23.0'
}
```
[Android IoT Samples README](./android/app/src/main/assets/README.md)

Replace `0.23.0` in `software.amazon.awssdk.crt:android:0.23.0` with the latest version of the CRT.
