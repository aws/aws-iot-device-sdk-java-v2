...
git clone --branch v0.10.3 https://github.com/awslabs/aws-crt-java.git
...
``` sh
git clone --recursive --branch v0.10.3 https://github.com/awslabs/aws-crt-java.git
git clone https://github.com/awslabs/aws-iot-device-sdk-java-v2.git
...
dependencies {
    implementation 'software.amazon.awssdk.crt:android:0.10.3'
}
```
