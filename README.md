...
Replace `1.11.2` in `<version>1.11.2</version>` with the latest release version for the SDK.
...
#     (Use the latest version of the CRT here instead of "v0.21.10")
git clone --branch v0.21.10 --recurse-submodules https://github.com/awslabs/aws-crt-java.git
cd aws-crt-java
...
dependencies {
    implementation 'software.amazon.awssdk.crt:android:0.21.10'
}
```

Replace `0.21.10` in `software.amazon.awssdk.crt:android:0.21.10` with the latest version of the CRT.
...
Latest released version: v1.11.3
