 ...
 */
public class UnsubscribeFromIoTCoreResponse implements EventStreamJsonMessage {
  public static final String APPLICATION_MODEL_TYPE = "aws.greengrass#UnsubscribeFromIoTCoreResponse";

  public static final UnsubscribeFromIoTCoreResponse VOID;

  static {
    VOID = new UnsubscribeFromIoTCoreResponse() {
      @Override
