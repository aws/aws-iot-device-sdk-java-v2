...
mvn exec:java -Dexec.mainClass="customauthorizerconnect.CustomAuthorizerConnect" -Daws.crt.ci="True" -Daws.crt.debugnative="True" -Daws.crt.log.level="Trace" -Daws.crt.log.destination="Stdout" -Dexec.arguments="--endpoint,$ENDPOINT,--cert,/tmp/certificate.pem,--key,/tmp/privatekey.pem,--auth_name,TestSDKAuthorizer,--auth_username,V2SDK"
