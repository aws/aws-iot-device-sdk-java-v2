...
# (Use the latest version of the SDK here instead of `v1.32.0`)
git clone --branch v1.32.0 --recurse-submodules https://github.com/aws/aws-iot-device-sdk-java-v2.git
...
dependencies {
    api 'software.amazon.awssdk.iotdevicesdk:aws-iot-device-sdk-android:1.32.0'
}
```
Replace `1.32.0` in `software.amazon.awssdk.iotdevicesdk:aws-iot-device-sdk-android:1.32.0` with the latest release version for the SDK.
