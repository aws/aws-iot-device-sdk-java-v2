...
# (Use the latest version of the SDK here instead of `v1.30.1`)
git clone --branch v1.30.1 --recurse-submodules https://github.com/aws/aws-iot-device-sdk-java-v2.git
...
dependencies {
    api 'software.amazon.awssdk.iotdevicesdk:aws-iot-device-sdk-android:1.30.1'
}
```
Replace `1.30.1` in `software.amazon.awssdk.iotdevicesdk:aws-iot-device-sdk-android:1.30.1` with the latest release version for the SDK.
