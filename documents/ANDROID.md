...
# (Use the latest version of the SDK here instead of `v1.30.2`)
git clone --branch v1.30.2 --recurse-submodules https://github.com/aws/aws-iot-device-sdk-java-v2.git
...
dependencies {
    api 'software.amazon.awssdk.iotdevicesdk:aws-iot-device-sdk-android:1.30.2'
}
```
Replace `1.30.2` in `software.amazon.awssdk.iotdevicesdk:aws-iot-device-sdk-android:1.30.2` with the latest release version for the SDK.
