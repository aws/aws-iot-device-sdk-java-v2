...
# (Use the latest version of the SDK here instead of `v1.17.6`)
git clone --branch v1.17.6 --recurse-submodules https://github.com/aws/aws-iot-device-sdk-java-v2.git
...
dependencies {
    api 'software.amazon.awssdk.iotdevicesdk:aws-iot-device-sdk-android:1.17.6'
}
```
Replace `1.17.6` in `software.amazon.awssdk.iotdevicesdk:aws-iot-device-sdk-android:1.17.6` with the latest release version for the SDK.
