...
public class CsrProvisioning {
    ...
    private static ApplicationContext buildSampleContext(String [] args) throws Exception {
        ...
        cliOptions.addOption(Option.builder("s").longOpt("csr").desc("file path to a CSR file in PEM format").hasArg().required().build());
        ...
        if (commandLine.hasOption("help")) {
            ...
            formatter.printHelp("CsrProvisioning", cliOptions);
            return null;
        }

        context.csr = new String(Files.readAllBytes(Paths.get(commandLine.getOptionValue("csr"))));
    ...
    public static void main(String[] args) {
        ...
        try (ApplicationContext context = buildSampleContext(args)) {
            ...
            CreateCertificateFromCsrRequest createRequest = new CreateCertificateFromCsrRequest();
            createRequest.certificateSigningRequest = context.csr;
            CreateCertificateFromCsrResponse createResponse = context.identityClient.createCertificateFromCsr(createRequest).get();
            System.out.println("CreateCertificateFromCsrResponse: \n  " + gson.toJson(createResponse));
