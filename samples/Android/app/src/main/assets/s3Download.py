...
def main():
    ...
    download_file(object_name="libopensc.so", save_name="/Volumes/workplace/android-pkcs11/aws-iot-device-sdk-java-v2/samples/Android/app/src/main/resources/lib/arm64-v8a/libopensc.so")
    download_file(object_name="libpcsclite.so", save_name="/Volumes/workplace/android-pkcs11/aws-iot-device-sdk-java-v2/samples/Android/app/src/main/assets/libpcsclite.so")
