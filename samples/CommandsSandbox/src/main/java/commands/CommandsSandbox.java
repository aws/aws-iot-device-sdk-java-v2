...
public class CommandsSandbox {
    ...
    private static void printCommandHelp() {
        ...
        System.out.println("                     creates an AWS IoT Command execution targeted for the IoT thing specified");
        System.out.println("                     at the application start");
        System.out.println("    send-command-to-client <command-id> [<timeout>]");
        System.out.println("                     creates an AWS IoT Command execution targeted for the MQTT client specified");
        System.out.println("                     at the application start");
